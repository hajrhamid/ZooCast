...
<div className="flex items-center justify-between p-6 border-t border-gray-200">
  ...
  <div className="flex items-center gap-3">
    ...
    <button
      ...
      className={`px-4 py-2 rounded-lg border ${currentPage === 1 ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white hover:bg-gray-50 text-gray-700"}`}
    ...
    <div className="px-4 py-2 rounded-lg bg-emerald-600 text-white">
    ...
    <button
      ...
      className={`px-4 py-2 rounded-lg border ${currentPage === totalPages ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white hover:bg-gray-50 text-gray-700"}`}
